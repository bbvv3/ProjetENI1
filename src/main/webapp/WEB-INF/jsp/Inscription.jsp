...
<body>
	...
	<div>
		...
		<form action="${pageContext.servletContext.contextPath}/Inscription" method="post"><br>
			<label for="id_pseudo">Pseudo* : </label><input type="text" id="id_pseudo" name="pseudo" size="10" required/><br>
			...
			<label for="id_mail">Email* : </label><input type="email" id="id_mail" name="mail" size="50" required/><br>
			<label for="id_tel">Téléphone* : </label><input type="tel" id="id_tel" name="tel" size="15" required/><br>
			...
			<label for="id_mdp">Mot de passe* : </label><input type="password" id="id_mdp" name="mdp" required/><br>
			<label for="id_mdp2">Confirmation* : </label><input type="password" id="id_mdp2" name="mdp2" required/><br>
